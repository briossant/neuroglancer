...
- On image layers, the value ``0`` (``VOXEL_EMPTY_VALUE``) cannot be used as a paint value, as it is reserved to represent empty (unedited) voxels in the preview and is rendered as transparent.
